...
exports.errors = {
    ...
    INVALID_COST_PER_VOTE: '"COST PER VOTE SHOULD BE GREATER THAN ZER0"',
    INVALID_CATEGORY: '"CATEGORY DOES NOT EXIST"',
    INVALID_CANDIDATE: '"CANDIDATE DOES NOT EXIST"',
    INVALID_CALLER: '"CALLER IS UNAUTHORIZED"',
    INVALID_ELECTION: '"ELECTION DOES NOT EXIST"',
    INVALID_PUB_KEY: '"PUB KEY ALREADY EXISTS FOR ELECTION"',
    INVALID_PERIOD: '"CANNOT INVOKE THIS FUNCTIONALITY AT THIS TIME"',
    INVALID_TOKEN: '"INVALID TOKEN"',
    INVALID_TOKEN_DECODE: '"INVALID TOKEN DECODE"',
    INVALID_VOTE: '"INVALID VOTE"',
    INVALID_TOKEN_USED: '"INVALID TOKEN USED"',
    DUPLICATE_CATEGORY: '"CANNOT HAVE MORE THAT ONE VOTE PARAM IN SAME CATEGORY"',
    INSUFFICIENT_AMOUT: '"INSUFFICIENT AMOUNT TO PAY FOR VOTE"',
    INVALID_VOTE_COUNT: '"THERE ARE TOO MANY VOTES THAN ALLOWED"',
};
